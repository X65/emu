...
static void _ui_ria816_draw_state(ui_ria816_t* win) {
    ...
    if (ImGui::BeginTable("##cpu_vectors", 3)) {
        ...
        ImGui::Text("IRQ");
        ImGui::TableNextColumn();
        ui_util_u16("", ria->reg[RIA816_CPU_E_IRQB_BRK]);
        ImGui::TableNextColumn();
        ui_util_u16("", ria->reg[RIA816_CPU_N_IRQB]);
        ImGui::TableNextColumn();
        ImGui::Text("RESET");
        ImGui::TableNextColumn();
        ui_util_u16("", ria->reg[RIA816_CPU_E_RESETB]);
        ImGui::TableNextColumn();
        ImGui::Text("    -");
        ImGui::TableNextColumn();
        ImGui::Text("NMI");
        ImGui::TableNextColumn();
        ui_util_u16("", ria->reg[RIA816_CPU_E_NMIB]);
        ImGui::TableNextColumn();
        ui_util_u16("", ria->reg[RIA816_CPU_N_NMIB]);
        ImGui::TableNextColumn();
        ImGui::Text("ABORT");
        ImGui::TableNextColumn();
        ui_util_u16("", ria->reg[RIA816_CPU_E_ABORTB]);
        ImGui::TableNextColumn();
        ui_util_u16("", ria->reg[RIA816_CPU_N_ABORTB]);
        ImGui::TableNextColumn();
        ImGui::Text("BRK");
        ImGui::TableNextColumn();
        ui_util_u16("", ria->reg[RIA816_CPU_E_IRQB_BRK]);
        ImGui::TableNextColumn();
        ui_util_u16("", ria->reg[RIA816_CPU_N_BRK]);
        ImGui::TableNextColumn();
        ImGui::Text("COP");
        ImGui::TableNextColumn();
        ui_util_u16("", ria->reg[RIA816_CPU_E_COP]);
        ImGui::TableNextColumn();
        ui_util_u16("", ria->reg[RIA816_CPU_N_COP]);
        ImGui::TableNextColumn();
        ImGui::EndTable();
    }
}
