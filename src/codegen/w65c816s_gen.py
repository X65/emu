...
def i_jsrx(o):
    ...
    o.t('_VDA(_GB());_SA(c->AD+_X(c));')
    o.t('_VDA(_GB());_SA(c->AD+_X(c)+1);c->AD=_GD();')
    o.t('c->PC=(_GD()<<8)|c->AD;')
...
def i_rti(o):
    cmt(o,'RTI')
    # put PC+1 on stack and do a junk read
    o.t('_SA(0x0100|++c->PC);')
    # and again
    o.t('_SA(0x0100|++c->PC);')
