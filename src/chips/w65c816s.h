...
#define _W65816_NZ16(p,v) ((p&~(W65816_NF|W65816_ZF))|((v&0xFFFF)?(v&W65816_NF):W65816_ZF))
...
#define _GB() ((uint16_t)((pins>>32)&0xFFULL))
/* extract 24-bit address from pin mask */
...
uint64_t w65816_tick(w65816_t* c, uint64_t pins) {
    ...
    /* BRK s */
        ...
        case (0x00<<4)|4: _VDA(0);_SAD(0x0100|_S(c)--,(_E(c)?c->P|W65816_UF:c->P));if(c->brk_flags&W65816_BRK_RESET){c->AD=0xFFFC;}else{_WR();if(c->brk_flags&W65816_BRK_NMI){c->AD=_E(c)?0xFFFA:0xFFEA;}else{c->AD=_E(c)?0xFFFE:(c->brk_flags&(W65816_BRK_IRQ)?0xFFEE:0xFFE6);}}break;
    ...
    /* ORA (d,x) */
        ...
        case (0x01<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0x01<<4)|2: _VDA(c->DBR);c->AD=(c->AD+_X(c))&0xFF;_SA(c->AD);break;
        case (0x01<<4)|3: _VDA(c->DBR);_SA((c->AD+1)&0xFF);c->AD=_GD();break;
        case (0x01<<4)|4: _VDA(c->DBR);_SA((_GD()<<8)|c->AD);break;
        case (0x01<<4)|5: _A(c)|=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x01<<4)|6: _B(c)|=_GD();_NZ16(_C(c));_FETCH();break;
    ...
    /* COP s */
        ...
        case (0x02<<4)|4: _VDA(0);_SAD(0x0100|_S(c)--,(_E(c)?c->P|W65816_UF:c->P));_WR();c->AD=_E(c)?0xFFF4:0xFFE4;break;
    ...
    /* ORA d,s */
        ...
        case (0x03<<4)|2: _B(c)|=_GD();_NZ16(_C(c));break;
        case (0x03<<4)|3: _FETCH();break;
    ...
    /* TSB d */
        case (0x04<<4)|0: _VPA();_SA(c->PC++);break;
        case (0x04<<4)|1: _VDA(0);_SA(_GD());break;
        case (0x04<<4)|2: c->AD=_GD();                    if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x04<<4)|3: if(_a8(c)){_VDA(_GB());_SD(_A(c)|c->AD);_WR();_Z(_A(c)&c->AD);}else{c->AD|=_GD()<<8;}break;
        case (0x04<<4)|4: if(_a8(c)){_FETCH();                                          }else{_VDA(_GB());_SD(_B(c)|(c->AD>>8));_WR();_Z16(_C(c)&c->AD);}break;
        case (0x04<<4)|5: _VDA(_GB());_SALD(_GAL()-1,_A(c)|(c->AD&0xFF));_WR();break;
        case (0x04<<4)|6: _FETCH();break;
        case (0x04<<4)|7: assert(false);break;
        case (0x04<<4)|8: assert(false);break;
    /* ORA d */
        case (0x05<<4)|0: _VPA();_SA(c->PC++);break;
        case (0x05<<4)|1: _VDA(0);_SA(_GD());break;
        case (0x05<<4)|2: _A(c)|=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x05<<4)|3: _B(c)|=_GD();_NZ16(_C(c));_FETCH();break;
    ...
    /* ASL d */
        case (0x06<<4)|0: _VPA();_SA(c->PC++);break;
        case (0x06<<4)|1: _VDA(0);_SA(_GD());break;
        case (0x06<<4)|2: c->AD=_GD();             if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x06<<4)|3: if(_a8(c)){_VDA(_GB());_SD(_w65816_asl(c,c->AD));_WR();}else{c->AD|=_GD()<<8;}break;
        case (0x06<<4)|4: if(_a8(c)){_FETCH();                                   }else{_VDA(_GB());c->AD=_w65816_asl16(c,c->AD);_SD(c->AD>>8);_WR();}break;
        case (0x06<<4)|5: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0x06<<4)|6: _FETCH();break;
        case (0x06<<4)|7: assert(false);break;
        case (0x06<<4)|8: assert(false);break;
    /* ORA [d] */
        case (0x07<<4)|0: /* (unimpl) */;break;
        case (0x07<<4)|1: _A(c)|=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x07<<4)|2: _B(c)|=_GD();_NZ16(_C(c));break;
        case (0x07<<4)|3: _FETCH();break;
    ...
    /* PHP s */
        ...
        case (0x08<<4)|1: _VDA(0);_SAD(0x0100|_S(c)--,(_E(c)?c->P|W65816_UF:c->P));_WR();break;
    ...
    /* ASL A */
        ...
        case (0x0A<<4)|1: _A(c)=_w65816_asl(c,_A(c));_FETCH();break;
    ...
    /* PHD s */
        ...
        case (0x0B<<4)|1: _VDA(0);_SAD(0x0100|_S(c)--,c->D>>8);_WR();break;
        case (0x0B<<4)|2: _VDA(0);_SAD(0x0100|_S(c)--,c->D);_WR();break;
    ...
    /* ASL a */
        ...
        case (0x0E<<4)|3: c->AD=_GD();             if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x0E<<4)|4: if(_a8(c)){_VDA(_GB());_SD(_w65816_asl(c,c->AD));_WR();}else{c->AD|=_GD()<<8;}break;
        case (0x0E<<4)|5: if(_a8(c)){_FETCH();                                   }else{_VDA(_GB());c->AD=_w65816_asl16(c,c->AD);_SD(c->AD>>8);_WR();}break;
        case (0x0E<<4)|6: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0x0E<<4)|7: _FETCH();break;
        case (0x0E<<4)|8: assert(false);break;
    /* ORA al */
        case (0x0F<<4)|0: /* (unimpl) */;break;
        case (0x0F<<4)|1: _A(c)|=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x0F<<4)|2: _B(c)|=_GD();_NZ16(_C(c));break;
        case (0x0F<<4)|3: _FETCH();break;
    ...
    /* BPL r */
        ...
        case (0x10<<4)|2: _SA((c->PC&0xFF00)|(c->AD&0x00FF));if((c->AD&0xFF00)==(c->PC&0xFF00)){c->PC=c->AD;c->irq_pip>>=1;c->nmi_pip>>=1;_FETCH();};break;
    ...
    /* ORA (d),y */
        ...
        case (0x11<<4)|1: _VDA(c->DBR);c->AD=_GD();_SA(c->AD);break;
        case (0x11<<4)|2: _VDA(c->DBR);_SA((c->AD+1)&0xFF);c->AD=_GD();break;
        case (0x11<<4)|3: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_Y(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_Y(c))>>8)))&1;break;
    ...
    /* ORA (d) */
        ...
        case (0x12<<4)|1: _A(c)|=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x12<<4)|2: _B(c)|=_GD();_NZ16(_C(c));break;
        case (0x12<<4)|3: _FETCH();break;
    ...
    /* ORA (d,s),y */
        ...
        case (0x13<<4)|1: _A(c)|=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x13<<4)|2: _B(c)|=_GD();_NZ16(_C(c));break;
        case (0x13<<4)|3: _FETCH();break;
    ...
    /* TRB d */
        case (0x14<<4)|0: _VPA();_SA(c->PC++);break;
        case (0x14<<4)|1: _VDA(0);_SA(_GD());break;
        case (0x14<<4)|2: c->AD=_GD();                     if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x14<<4)|3: if(_a8(c)){_VDA(_GB());_SD(~_A(c)&c->AD);_WR();_Z(_A(c)&c->AD);}else{c->AD|=_GD()<<8;}break;
        case (0x14<<4)|4: if(_a8(c)){_FETCH();                                           }else{_VDA(_GB());_SD(~_B(c)&(c->AD>>8));_WR();_Z16(_C(c)&c->AD);}break;
        case (0x14<<4)|5: _VDA(_GB());_SALD(_GAL()-1,~_A(c)&(c->AD&0xFF));_WR();break;
        case (0x14<<4)|6: _FETCH();break;
        case (0x14<<4)|7: assert(false);break;
        case (0x14<<4)|8: assert(false);break;
    /* ORA d,x */
        case (0x15<<4)|0: _VPA();_SA(c->PC++);break;
        case (0x15<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0x15<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}break;
        case (0x15<<4)|3: _A(c)|=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x15<<4)|4: _B(c)|=_GD();_NZ16(_C(c));_FETCH();break;
    ...
    /* ASL d,x */
        ...
        case (0x16<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0x16<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}break;
        case (0x16<<4)|3: c->AD=_GD();             if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x16<<4)|4: if(_a8(c)){_VDA(_GB());_SD(_w65816_asl(c,c->AD));_WR();}else{c->AD|=_GD()<<8;}break;
        case (0x16<<4)|5: if(_a8(c)){_FETCH();                                   }else{_VDA(_GB());c->AD=_w65816_asl16(c,c->AD);_SD(c->AD>>8);_WR();}break;
        case (0x16<<4)|6: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0x16<<4)|7: _FETCH();break;
        case (0x16<<4)|8: assert(false);break;
    /* ORA [d],y */
        case (0x17<<4)|0: /* (unimpl) */;break;
        case (0x17<<4)|1: _A(c)|=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x17<<4)|2: _B(c)|=_GD();_NZ16(_C(c));break;
        case (0x17<<4)|3: _FETCH();break;
    ...
    /* ORA a,y */
        ...
        case (0x19<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_Y(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_Y(c))>>8)))&1;break;
    ...
    /* ORA a,x */
        ...
        case (0x1D<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_X(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_X(c))>>8)))&1;break;
    ...
    /* ASL a,x */
        ...
        case (0x1E<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_X(c))&0xFF));break;
        case (0x1E<<4)|3: _VDA(c->DBR);_SA(c->AD+_X(c));break;
        case (0x1E<<4)|4: c->AD=_GD();             if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x1E<<4)|5: if(_a8(c)){_VDA(_GB());_SD(_w65816_asl(c,c->AD));_WR();}else{c->AD|=_GD()<<8;}break;
        case (0x1E<<4)|6: if(_a8(c)){_FETCH();                                   }else{_VDA(_GB());c->AD=_w65816_asl16(c,c->AD);_SD(c->AD>>8);_WR();}break;
        case (0x1E<<4)|7: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0x1E<<4)|8: _FETCH();break;
    /* ORA al,x */
        case (0x1F<<4)|0: /* (unimpl) */;break;
        case (0x1F<<4)|1: _A(c)|=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x1F<<4)|2: _B(c)|=_GD();_NZ16(_C(c));break;
        case (0x1F<<4)|3: _FETCH();break;
    ...
    /* JSR a */
        ...
        case (0x20<<4)|1: _SA(0x0100|_S(c));c->AD=_GD();break;
        case (0x20<<4)|2: _VDA(0);_SAD(0x0100|_S(c)--,c->PC>>8);_WR();break;
        case (0x20<<4)|3: _VDA(0);_SAD(0x0100|_S(c)--,c->PC);_WR();break;
        case (0x20<<4)|4: _VPA();_SA(c->PC);break;
        case (0x20<<4)|5: c->PC=(_GD()<<8)|c->AD;_FETCH();break;
    ...
    /* AND (d,x) */
        ...
        case (0x21<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0x21<<4)|2: _VDA(c->DBR);c->AD=(c->AD+_X(c))&0xFF;_SA(c->AD);break;
        case (0x21<<4)|3: _VDA(c->DBR);_SA((c->AD+1)&0xFF);c->AD=_GD();break;
        case (0x21<<4)|4: _VDA(c->DBR);_SA((_GD()<<8)|c->AD);break;
        case (0x21<<4)|5: _A(c)&=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x21<<4)|6: _B(c)&=_GD();_NZ16(_C(c));_FETCH();break;
        case (0x21<<4)|7: assert(false);break;
        case (0x21<<4)|8: assert(false);break;
    /* JSL al (unimpl) */
        case (0x22<<4)|0: /* (unimpl) */;break;
        case (0x22<<4)|1: break;
    ...
    /* AND d,s */
        ...
        case (0x23<<4)|1: _A(c)&=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x23<<4)|2: _B(c)&=_GD();_NZ16(_C(c));break;
        case (0x23<<4)|3: _FETCH();break;
    ...
    /* BIT d */
        case (0x24<<4)|0: _VPA();_SA(c->PC++);break;
        case (0x24<<4)|1: _VDA(0);_SA(_GD());break;
        case (0x24<<4)|2: if(_a8(c)){_w65816_bit(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x24<<4)|3: _w65816_bit16(c,c->AD|(_GD()<<8));_FETCH();break;
    ...
    /* AND d */
        case (0x25<<4)|0: _VPA();_SA(c->PC++);break;
        case (0x25<<4)|1: _VDA(0);_SA(_GD());break;
        case (0x25<<4)|2: _A(c)&=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x25<<4)|3: _B(c)&=_GD();_NZ16(_C(c));_FETCH();break;
    ...
    /* ROL d */
        case (0x26<<4)|0: _VPA();_SA(c->PC++);break;
        case (0x26<<4)|1: _VDA(0);_SA(_GD());break;
        case (0x26<<4)|2: c->AD=_GD();             if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x26<<4)|3: if(_a8(c)){_VDA(_GB());_SD(_w65816_rol(c,c->AD));_WR();}else{c->AD|=_GD()<<8;}break;
        case (0x26<<4)|4: if(_a8(c)){_FETCH();                                   }else{_VDA(_GB());c->AD=_w65816_rol16(c,c->AD);_SD(c->AD>>8);_WR();}break;
        case (0x26<<4)|5: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0x26<<4)|6: _FETCH();break;
        case (0x26<<4)|7: assert(false);break;
        case (0x26<<4)|8: assert(false);break;
    /* AND [d] */
        case (0x27<<4)|0: /* (unimpl) */;break;
        case (0x27<<4)|1: _A(c)&=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x27<<4)|2: _B(c)&=_GD();_NZ16(_C(c));break;
        case (0x27<<4)|3: _FETCH();break;
    ...
    /* PLP s */
        ...
        case (0x28<<4)|2: _VDA(0);_SA(0x0100|++_S(c));break;
    ...
    /* AND # */
        ...
        case (0x29<<4)|1: _A(c)&=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
    ...
    /* ROL A */
        ...
        case (0x2A<<4)|1: _A(c)=_w65816_rol(c,_A(c));_FETCH();break;
    ...
    /* PLD s */
        ...
        case (0x2B<<4)|2: _VDA(0);_SA(0x0100|_S(c)++);break;
        case (0x2B<<4)|3: _VDA(0);_SA(0x0100|_S(c));c->AD=_GD();break;
    ...
    /* ROL a */
        ...
        case (0x2E<<4)|3: c->AD=_GD();             if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x2E<<4)|4: if(_a8(c)){_VDA(_GB());_SD(_w65816_rol(c,c->AD));_WR();}else{c->AD|=_GD()<<8;}break;
        case (0x2E<<4)|5: if(_a8(c)){_FETCH();                                   }else{_VDA(_GB());c->AD=_w65816_rol16(c,c->AD);_SD(c->AD>>8);_WR();}break;
        case (0x2E<<4)|6: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0x2E<<4)|7: _FETCH();break;
        case (0x2E<<4)|8: assert(false);break;
    /* AND al */
        case (0x2F<<4)|0: /* (unimpl) */;break;
        case (0x2F<<4)|1: _A(c)&=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x2F<<4)|2: _B(c)&=_GD();_NZ16(_C(c));break;
        case (0x2F<<4)|3: _FETCH();break;
    ...
    /* BMI r */
        ...
        case (0x30<<4)|2: _SA((c->PC&0xFF00)|(c->AD&0x00FF));if((c->AD&0xFF00)==(c->PC&0xFF00)){c->PC=c->AD;c->irq_pip>>=1;c->nmi_pip>>=1;_FETCH();};break;
    ...
    /* AND (d),y */
        ...
        case (0x31<<4)|1: _VDA(c->DBR);c->AD=_GD();_SA(c->AD);break;
        case (0x31<<4)|2: _VDA(c->DBR);_SA((c->AD+1)&0xFF);c->AD=_GD();break;
        case (0x31<<4)|3: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_Y(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_Y(c))>>8)))&1;break;
    ...
    /* AND (d) */
        ...
        case (0x32<<4)|1: _A(c)&=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x32<<4)|2: _B(c)&=_GD();_NZ16(_C(c));break;
        case (0x32<<4)|3: _FETCH();break;
    ...
    /* AND (d,s),y */
        ...
        case (0x33<<4)|1: _A(c)&=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x33<<4)|2: _B(c)&=_GD();_NZ16(_C(c));break;
        case (0x33<<4)|3: _FETCH();break;
    ...
    /* BIT d,x */
        ...
        case (0x34<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0x34<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}break;
        case (0x34<<4)|3: if(_a8(c)){_w65816_bit(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x34<<4)|4: _w65816_bit16(c,c->AD|(_GD()<<8));_FETCH();break;
    ...
    /* AND d,x */
        ...
        case (0x35<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0x35<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}break;
        case (0x35<<4)|3: _A(c)&=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x35<<4)|4: _B(c)&=_GD();_NZ16(_C(c));_FETCH();break;
    ...
    /* ROL d,x */
        ...
        case (0x36<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0x36<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}break;
        case (0x36<<4)|3: c->AD=_GD();             if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x36<<4)|4: if(_a8(c)){_VDA(_GB());_SD(_w65816_rol(c,c->AD));_WR();}else{c->AD|=_GD()<<8;}break;
        case (0x36<<4)|5: if(_a8(c)){_FETCH();                                   }else{_VDA(_GB());c->AD=_w65816_rol16(c,c->AD);_SD(c->AD>>8);_WR();}break;
        case (0x36<<4)|6: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0x36<<4)|7: _FETCH();break;
        case (0x36<<4)|8: assert(false);break;
    /* AND [d],y */
        case (0x37<<4)|0: /* (unimpl) */;break;
        case (0x37<<4)|1: _A(c)&=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x37<<4)|2: _B(c)&=_GD();_NZ16(_C(c));break;
    ...
    /* AND a,y */
        ...
        case (0x39<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_Y(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_Y(c))>>8)))&1;break;
    ...
    /* BIT a,x */
        ...
        case (0x3C<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_X(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_X(c))>>8)))&1;break;
    ...
    /* AND a,x */
        ...
        case (0x3D<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_X(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_X(c))>>8)))&1;break;
    ...
    /* ROL a,x */
        ...
        case (0x3E<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_X(c))&0xFF));break;
        case (0x3E<<4)|3: _VDA(c->DBR);_SA(c->AD+_X(c));break;
        case (0x3E<<4)|4: c->AD=_GD();             if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x3E<<4)|5: if(_a8(c)){_VDA(_GB());_SD(_w65816_rol(c,c->AD));_WR();}else{c->AD|=_GD()<<8;}break;
        case (0x3E<<4)|6: if(_a8(c)){_FETCH();                                   }else{_VDA(_GB());c->AD=_w65816_rol16(c,c->AD);_SD(c->AD>>8);_WR();}break;
        case (0x3E<<4)|7: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0x3E<<4)|8: _FETCH();break;
    /* AND al,x */
        case (0x3F<<4)|0: /* (unimpl) */;break;
        case (0x3F<<4)|1: _A(c)&=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x3F<<4)|2: _B(c)&=_GD();_NZ16(_C(c));break;
        case (0x3F<<4)|3: _FETCH();break;
    ...
    /* RTI s */
        ...
        case (0x40<<4)|4: _VDA(0);_SA(0x0100|++_S(c));c->P=_GD();if(_E(c))c->P=(c->P|W65816_BF)&~W65816_UF;break;
    ...
    /* EOR (d,x) */
        ...
        case (0x41<<4)|2: _VDA(c->DBR);c->AD=(c->AD+_X(c))&0xFF;_SA(c->AD);break;
        case (0x41<<4)|3: _VDA(c->DBR);_SA((c->AD+1)&0xFF);c->AD=_GD();break;
        case (0x41<<4)|4: _VDA(c->DBR);_SA((_GD()<<8)|c->AD);break;
        case (0x41<<4)|5: _A(c)^=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x41<<4)|6: _B(c)^=_GD();_NZ16(_C(c));_FETCH();break;
    ...
    /* EOR d,s */
        ...
        case (0x43<<4)|1: _A(c)^=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x43<<4)|2: _B(c)^=_GD();_NZ16(_C(c));break;
        case (0x43<<4)|3: _FETCH();break;
    ...
    /* EOR d */
        case (0x45<<4)|0: _VPA();_SA(c->PC++);break;
        case (0x45<<4)|1: _VDA(0);_SA(_GD());break;
        case (0x45<<4)|2: _A(c)^=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x45<<4)|3: _B(c)^=_GD();_NZ16(_C(c));_FETCH();break;
    ...
    /* LSR d */
        case (0x46<<4)|0: _VPA();_SA(c->PC++);break;
        case (0x46<<4)|1: _VDA(0);_SA(_GD());break;
        case (0x46<<4)|2: c->AD=_GD();             if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x46<<4)|3: if(_a8(c)){_VDA(_GB());_SD(_w65816_lsr(c,c->AD));_WR();}else{c->AD|=_GD()<<8;}break;
        case (0x46<<4)|4: if(_a8(c)){_FETCH();                                   }else{_VDA(_GB());c->AD=_w65816_lsr16(c,c->AD);_SD(c->AD>>8);_WR();}break;
        case (0x46<<4)|5: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0x46<<4)|6: _FETCH();break;
        case (0x46<<4)|7: assert(false);break;
        case (0x46<<4)|8: assert(false);break;
    /* EOR [d] */
        case (0x47<<4)|0: /* (unimpl) */;break;
        case (0x47<<4)|1: _A(c)^=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x47<<4)|2: _B(c)^=_GD();_NZ16(_C(c));break;
        case (0x47<<4)|3: _FETCH();break;
    ...
    /* PHA s */
        ...
        case (0x48<<4)|1: _VDA(0);_SAD(0x0100|_S(c)--,_A(c));_WR();break;
        case (0x48<<4)|2: _FETCH();break;
    ...
    /* EOR # */
        ...
        case (0x49<<4)|1: _A(c)^=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
    ...
    /* LSR A */
        ...
        case (0x4A<<4)|1: _A(c)=_w65816_lsr(c,_A(c));_FETCH();break;
    ...
    /* PHK s */
        ...
        case (0x4B<<4)|1: _VDA(0);_SAD(0x0100|_S(c)--,c->PBR);_WR();break;
    ...
    /* JMP a */
        ...
        case (0x4C<<4)|2: c->PC=(_GD()<<8)|c->AD;_FETCH();break;
    ...
    /* LSR a */
        ...
        case (0x4E<<4)|3: c->AD=_GD();             if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x4E<<4)|4: if(_a8(c)){_VDA(_GB());_SD(_w65816_lsr(c,c->AD));_WR();}else{c->AD|=_GD()<<8;}break;
        case (0x4E<<4)|5: if(_a8(c)){_FETCH();                                   }else{_VDA(_GB());c->AD=_w65816_lsr16(c,c->AD);_SD(c->AD>>8);_WR();}break;
        case (0x4E<<4)|6: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0x4E<<4)|7: _FETCH();break;
        case (0x4E<<4)|8: assert(false);break;
    /* EOR al */
        case (0x4F<<4)|0: /* (unimpl) */;break;
        case (0x4F<<4)|1: _A(c)^=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x4F<<4)|2: _B(c)^=_GD();_NZ16(_C(c));break;
        case (0x4F<<4)|3: _FETCH();break;
    ...
    /* BVC r */
        ...
        case (0x50<<4)|2: _SA((c->PC&0xFF00)|(c->AD&0x00FF));if((c->AD&0xFF00)==(c->PC&0xFF00)){c->PC=c->AD;c->irq_pip>>=1;c->nmi_pip>>=1;_FETCH();};break;
    ...
    /* EOR (d),y */
        ...
        case (0x51<<4)|1: _VDA(c->DBR);c->AD=_GD();_SA(c->AD);break;
        case (0x51<<4)|2: _VDA(c->DBR);_SA((c->AD+1)&0xFF);c->AD=_GD();break;
        case (0x51<<4)|3: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_Y(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_Y(c))>>8)))&1;break;
    ...
    /* EOR (d) */
        ...
        case (0x52<<4)|1: _A(c)^=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x52<<4)|2: _B(c)^=_GD();_NZ16(_C(c));break;
        case (0x52<<4)|3: _FETCH();break;
    ...
    /* EOR (d,s),y */
        ...
        case (0x53<<4)|1: _A(c)^=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x53<<4)|2: _B(c)^=_GD();_NZ16(_C(c));break;
        case (0x53<<4)|3: _FETCH();break;
    ...
    /* EOR d,x */
        ...
        case (0x55<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0x55<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}break;
        case (0x55<<4)|3: _A(c)^=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x55<<4)|4: _B(c)^=_GD();_NZ16(_C(c));_FETCH();break;
    ...
    /* LSR d,x */
        ...
        case (0x56<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0x56<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}break;
        case (0x56<<4)|3: c->AD=_GD();             if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x56<<4)|4: if(_a8(c)){_VDA(_GB());_SD(_w65816_lsr(c,c->AD));_WR();}else{c->AD|=_GD()<<8;}break;
        case (0x56<<4)|5: if(_a8(c)){_FETCH();                                   }else{_VDA(_GB());c->AD=_w65816_lsr16(c,c->AD);_SD(c->AD>>8);_WR();}break;
        case (0x56<<4)|6: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0x56<<4)|7: _FETCH();break;
        case (0x56<<4)|8: assert(false);break;
    /* EOR [d],y */
        case (0x57<<4)|0: /* (unimpl) */;break;
        case (0x57<<4)|1: _A(c)^=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x57<<4)|2: _B(c)^=_GD();_NZ16(_C(c));break;
        case (0x57<<4)|3: _FETCH();break;
    ...
    /* EOR a,y */
        ...
        case (0x59<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_Y(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_Y(c))>>8)))&1;break;
    ...
    /* PHY s */
        ...
        case (0x5A<<4)|1: _VDA(0);_SAD(0x0100|_S(c)--,_Y(c));_WR();break;
        case (0x5A<<4)|2: _FETCH();break;
    ...
    /* TCD i */
        ...
        case (0x5B<<4)|1: c->D=c->C;_NZ(c->C);_FETCH();break;
    ...
    /* JMP al */
        case (0x5C<<4)|0: /* (unimpl) */;break;
        case (0x5C<<4)|1: _VPA();_SA(c->PC++);break;
        case (0x5C<<4)|2: _VPA();_SA(c->PC++);c->AD=_GD();break;
        case (0x5C<<4)|3: c->PC=(_GD()<<8)|c->AD;_FETCH();break;
    ...
    /* EOR a,x */
        ...
        case (0x5D<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_X(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_X(c))>>8)))&1;break;
    ...
    /* LSR a,x */
        ...
        case (0x5E<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_X(c))&0xFF));break;
        case (0x5E<<4)|3: _VDA(c->DBR);_SA(c->AD+_X(c));break;
        case (0x5E<<4)|4: c->AD=_GD();             if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x5E<<4)|5: if(_a8(c)){_VDA(_GB());_SD(_w65816_lsr(c,c->AD));_WR();}else{c->AD|=_GD()<<8;}break;
        case (0x5E<<4)|6: if(_a8(c)){_FETCH();                                   }else{_VDA(_GB());c->AD=_w65816_lsr16(c,c->AD);_SD(c->AD>>8);_WR();}break;
        case (0x5E<<4)|7: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0x5E<<4)|8: _FETCH();break;
    /* EOR al,x */
        case (0x5F<<4)|0: /* (unimpl) */;break;
        case (0x5F<<4)|1: _A(c)^=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x5F<<4)|2: _B(c)^=_GD();_NZ16(_C(c));break;
        case (0x5F<<4)|3: _FETCH();break;
    ...
    /* RTS s */
        ...
        case (0x60<<4)|1: _SA(0x0100|_S(c)++);break;
        case (0x60<<4)|2: _VDA(0);_SA(0x0100|_S(c)++);break;
        case (0x60<<4)|3: _VDA(0);_SA(0x0100|_S(c));c->AD=_GD();break;
    ...
    /* ADC (d,x) */
        ...
        case (0x61<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0x61<<4)|2: _VDA(c->DBR);c->AD=(c->AD+_X(c))&0xFF;_SA(c->AD);break;
        case (0x61<<4)|3: _VDA(c->DBR);_SA((c->AD+1)&0xFF);c->AD=_GD();break;
        case (0x61<<4)|4: _VDA(c->DBR);_SA((_GD()<<8)|c->AD);break;
        case (0x61<<4)|5: if(_a8(c)){_w65816_adc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x61<<4)|6: _w65816_adc16(c,c->AD|(_GD()<<8));_FETCH();break;
    ...
    /* ADC d,s */
        ...
        case (0x63<<4)|1: if(_a8(c)){_w65816_adc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x63<<4)|2: _w65816_adc16(c,c->AD|(_GD()<<8));break;
        case (0x63<<4)|3: _FETCH();break;
        case (0x63<<4)|4: assert(false);break;
    ...
    /* STZ d */
        case (0x64<<4)|0: _VPA();_SA(c->PC++);break;
        case (0x64<<4)|1: _VDA(0);_SA(_GD());_VDA(_GB());_SD(0);_WR();break;
        case (0x64<<4)|2: if(_a8(c)){_FETCH();}else{_VDA(_GB());_SALD(_GAL()+1,0);_WR();}break;
        case (0x64<<4)|3: _FETCH();break;
        case (0x64<<4)|4: assert(false);break;
    ...
    /* ADC d */
        case (0x65<<4)|0: _VPA();_SA(c->PC++);break;
        case (0x65<<4)|1: _VDA(0);_SA(_GD());break;
        case (0x65<<4)|2: if(_a8(c)){_w65816_adc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x65<<4)|3: _w65816_adc16(c,c->AD|(_GD()<<8));_FETCH();break;
    ...
    /* ROR d */
        case (0x66<<4)|0: _VPA();_SA(c->PC++);break;
        case (0x66<<4)|1: _VDA(0);_SA(_GD());break;
        case (0x66<<4)|2: c->AD=_GD();             if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x66<<4)|3: if(_a8(c)){_VDA(_GB());_SD(_w65816_ror(c,c->AD));_WR();}else{c->AD|=_GD()<<8;}break;
        case (0x66<<4)|4: if(_a8(c)){_FETCH();                                   }else{_VDA(_GB());c->AD=_w65816_ror16(c,c->AD);_SD(c->AD>>8);_WR();}break;
        case (0x66<<4)|5: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0x66<<4)|6: _FETCH();break;
        case (0x66<<4)|7: assert(false);break;
        case (0x66<<4)|8: assert(false);break;
    /* ADC [d] */
        case (0x67<<4)|0: /* (unimpl) */;break;
        case (0x67<<4)|1: if(_a8(c)){_w65816_adc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x67<<4)|2: _w65816_adc16(c,c->AD|(_GD()<<8));break;
        case (0x67<<4)|3: _FETCH();break;
        case (0x67<<4)|4: assert(false);break;
    ...
    /* PLA s */
        ...
        case (0x68<<4)|2: _VDA(0);_SA(0x0100|++_S(c));break;
        case (0x68<<4)|3: _A(c)=_GD();_NZ(_A(c));_FETCH();break;
        case (0x68<<4)|4: assert(false);break;
    ...
    /* ADC # */
        ...
        case (0x69<<4)|1: if(_a8(c)){_w65816_adc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
    ...
    /* ROR A */
        ...
        case (0x6A<<4)|1: _A(c)=_w65816_ror(c,_A(c));_FETCH();break;
    ...
    /* RTL s (unimpl) */
        ...
        case (0x6B<<4)|1: _SA(0x0100|_S(c)++);_FETCH();break;
    ...
    /* JMP (a) */
        ...
        case (0x6C<<4)|3: _VDA(_GB());_SA((c->AD&0xFF00)|((c->AD+1)&0x00FF));c->AD=_GD();break;
    ...
    /* ROR a */
        ...
        case (0x6E<<4)|3: c->AD=_GD();             if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x6E<<4)|4: if(_a8(c)){_VDA(_GB());_SD(_w65816_ror(c,c->AD));_WR();}else{c->AD|=_GD()<<8;}break;
        case (0x6E<<4)|5: if(_a8(c)){_FETCH();                                   }else{_VDA(_GB());c->AD=_w65816_ror16(c,c->AD);_SD(c->AD>>8);_WR();}break;
        case (0x6E<<4)|6: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0x6E<<4)|7: _FETCH();break;
        case (0x6E<<4)|8: assert(false);break;
    /* ADC al */
        case (0x6F<<4)|0: /* (unimpl) */;break;
        case (0x6F<<4)|1: if(_a8(c)){_w65816_adc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x6F<<4)|2: _w65816_adc16(c,c->AD|(_GD()<<8));break;
        case (0x6F<<4)|3: _FETCH();break;
        case (0x6F<<4)|4: assert(false);break;
        case (0x6F<<4)|5: assert(false);break;
    ...
    /* BVS r */
        ...
        case (0x70<<4)|2: _SA((c->PC&0xFF00)|(c->AD&0x00FF));if((c->AD&0xFF00)==(c->PC&0xFF00)){c->PC=c->AD;c->irq_pip>>=1;c->nmi_pip>>=1;_FETCH();};break;
    ...
    /* ADC (d),y */
        ...
        case (0x71<<4)|1: _VDA(c->DBR);c->AD=_GD();_SA(c->AD);break;
        case (0x71<<4)|2: _VDA(c->DBR);_SA((c->AD+1)&0xFF);c->AD=_GD();break;
        case (0x71<<4)|3: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_Y(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_Y(c))>>8)))&1;break;
    ...
    /* ADC (d) */
        ...
        case (0x72<<4)|1: if(_a8(c)){_w65816_adc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x72<<4)|2: _w65816_adc16(c,c->AD|(_GD()<<8));break;
        case (0x72<<4)|3: _FETCH();break;
    ...
    /* ADC (d,s),y */
        ...
        case (0x73<<4)|1: if(_a8(c)){_w65816_adc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x73<<4)|2: _w65816_adc16(c,c->AD|(_GD()<<8));break;
    ...
    /* STZ d,x */
        ...
        case (0x74<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0x74<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}_VDA(_GB());_SD(0);_WR();break;
        case (0x74<<4)|3: if(_a8(c)){_FETCH();}else{_VDA(_GB());_SALD(_GAL()+1,0);_WR();}break;
    ...
    /* ADC d,x */
        ...
        case (0x75<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0x75<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}break;
        case (0x75<<4)|3: if(_a8(c)){_w65816_adc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x75<<4)|4: _w65816_adc16(c,c->AD|(_GD()<<8));_FETCH();break;
    ...
    /* ROR d,x */
        ...
        case (0x76<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0x76<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}break;
        case (0x76<<4)|3: c->AD=_GD();             if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x76<<4)|4: if(_a8(c)){_VDA(_GB());_SD(_w65816_ror(c,c->AD));_WR();}else{c->AD|=_GD()<<8;}break;
        case (0x76<<4)|5: if(_a8(c)){_FETCH();                                   }else{_VDA(_GB());c->AD=_w65816_ror16(c,c->AD);_SD(c->AD>>8);_WR();}break;
        case (0x76<<4)|6: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0x76<<4)|7: _FETCH();break;
        case (0x76<<4)|8: assert(false);break;
    /* ADC [d],y */
        case (0x77<<4)|0: /* (unimpl) */;break;
        case (0x77<<4)|1: if(_a8(c)){_w65816_adc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x77<<4)|2: _w65816_adc16(c,c->AD|(_GD()<<8));break;
    ...
    /* ADC a,y */
        ...
        case (0x79<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_Y(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_Y(c))>>8)))&1;break;
    ...
    /* PLY s */
        ...
        case (0x7A<<4)|2: _VDA(0);_SA(0x0100|++_S(c));break;
        case (0x7A<<4)|3: _Y(c)=_GD();_NZ(_Y(c));_FETCH();break;
    ...
    /* JMP (a,x) */
        ...
        case (0x7C<<4)|2: _VDA(_GB());c->AD|=_GD()<<8;_SA(c->AD);break;
        case (0x7C<<4)|3: _VDA(_GB());_SA((c->AD&0xFF00)|((c->AD+1)&0x00FF));c->AD=_GD();break;
        case (0x7C<<4)|4: c->PC=(_GD()<<8)|c->AD;_FETCH();break;
        case (0x7C<<4)|5: assert(false);break;
    ...
    /* ADC a,x */
        ...
        case (0x7D<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_X(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_X(c))>>8)))&1;break;
    ...
    /* ROR a,x */
        ...
        case (0x7E<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_X(c))&0xFF));break;
        case (0x7E<<4)|3: _VDA(c->DBR);_SA(c->AD+_X(c));break;
        case (0x7E<<4)|4: c->AD=_GD();             if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x7E<<4)|5: if(_a8(c)){_VDA(_GB());_SD(_w65816_ror(c,c->AD));_WR();}else{c->AD|=_GD()<<8;}break;
        case (0x7E<<4)|6: if(_a8(c)){_FETCH();                                   }else{_VDA(_GB());c->AD=_w65816_ror16(c,c->AD);_SD(c->AD>>8);_WR();}break;
        case (0x7E<<4)|7: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0x7E<<4)|8: _FETCH();break;
    /* ADC al,x */
        case (0x7F<<4)|0: /* (unimpl) */;break;
        case (0x7F<<4)|1: if(_a8(c)){_w65816_adc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0x7F<<4)|2: _w65816_adc16(c,c->AD|(_GD()<<8));break;
    ...
    /* BRA r */
        ...
        case (0x80<<4)|2: _SA((c->PC&0xFF00)|(c->AD&0x00FF));if((c->AD&0xFF00)==(c->PC&0xFF00)){c->PC=c->AD;c->irq_pip>>=1;c->nmi_pip>>=1;_FETCH();};break;
    ...
    /* STA (d,x) */
        ...
        case (0x81<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0x81<<4)|2: _VDA(c->DBR);c->AD=(c->AD+_X(c))&0xFF;_SA(c->AD);break;
        case (0x81<<4)|3: _VDA(c->DBR);_SA((c->AD+1)&0xFF);c->AD=_GD();break;
        case (0x81<<4)|4: _VDA(c->DBR);_SA((_GD()<<8)|c->AD);_VDA(_GB());_SD(_A(c));_WR();break;
        case (0x81<<4)|5: if(_a8(c)){_FETCH();}else{_VDA(_GB());_SALD(_GAL()+1,_B(c));_WR();}break;
        case (0x81<<4)|6: _FETCH();break;
        case (0x81<<4)|7: assert(false);break;
        case (0x81<<4)|8: assert(false);break;
    /* BRL rl (unimpl) */
        case (0x82<<4)|0: _FETCH();break;
        case (0x82<<4)|1: assert(false);break;
    ...
    /* STA d,s */
        case (0x83<<4)|0: /* (unimpl) */;_VDA(_GB());_SD(_A(c));_WR();break;
        case (0x83<<4)|1: if(_a8(c)){_FETCH();}else{_VDA(_GB());_SALD(_GAL()+1,_B(c));_WR();}break;
        case (0x83<<4)|2: _FETCH();break;
    ...
    /* STY d */
        case (0x84<<4)|0: _VPA();_SA(c->PC++);break;
        case (0x84<<4)|1: _VDA(0);_SA(_GD());_VDA(_GB());_SD(_Y(c));_WR();break;
        case (0x84<<4)|2: if(_i8(c)){_FETCH();}else{_VDA(_GB());_SALD(_GAL()+1,_YH(c));_WR();}break;
        case (0x84<<4)|3: _FETCH();break;
    ...
    /* STA d */
        case (0x85<<4)|0: _VPA();_SA(c->PC++);break;
        case (0x85<<4)|1: _VDA(0);_SA(_GD());_VDA(_GB());_SD(_A(c));_WR();break;
        case (0x85<<4)|2: if(_a8(c)){_FETCH();}else{_VDA(_GB());_SALD(_GAL()+1,_B(c));_WR();}break;
        case (0x85<<4)|3: _FETCH();break;
    ...
    /* STX d */
        case (0x86<<4)|0: _VPA();_SA(c->PC++);break;
        case (0x86<<4)|1: _VDA(0);_SA(_GD());_VDA(_GB());_SD(_X(c));_WR();break;
        case (0x86<<4)|2: if(_i8(c)){_FETCH();}else{_VDA(_GB());_SALD(_GAL()+1,_XH(c));_WR();}break;
        case (0x86<<4)|3: _FETCH();break;
    ...
    /* STA [d] */
        case (0x87<<4)|0: /* (unimpl) */;_VDA(_GB());_SD(_A(c));_WR();break;
        case (0x87<<4)|1: if(_a8(c)){_FETCH();}else{_VDA(_GB());_SALD(_GAL()+1,_B(c));_WR();}break;
        case (0x87<<4)|2: _FETCH();break;
    ...
    /* DEY i */
        ...
        case (0x88<<4)|1: if(_i8(c)){_Y(c)--;_NZ(_Y(c));}else{_Y16(c)--;_NZ16(_Y16(c));}_FETCH();break;
    ...
    /* BIT # */
        ...
        case (0x89<<4)|1: if(_a8(c)){_w65816_bit(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
    ...
    /* TXA i */
        ...
        case (0x8A<<4)|1: if(_a8(c)){_A(c)=_X(c);_NZ(_A(c));}else{_C(c)=_X16(c);_NZ16(_C(c));}_FETCH();break;
    ...
    /* PHB s */
        ...
        case (0x8B<<4)|1: _VDA(0);_SAD(0x0100|_S(c)--,c->DBR);_WR();break;
    ...
    /* STY a */
        ...
        case (0x8C<<4)|2: _VDA(c->DBR);_SA((_GD()<<8)|c->AD);_VDA(_GB());_SD(_Y(c));_WR();break;
    ...
    /* STA a */
        ...
        case (0x8D<<4)|2: _VDA(c->DBR);_SA((_GD()<<8)|c->AD);_VDA(_GB());_SD(_A(c));_WR();break;
    ...
    /* STX a */
        ...
        case (0x8E<<4)|2: _VDA(c->DBR);_SA((_GD()<<8)|c->AD);_VDA(_GB());_SD(_X(c));_WR();break;
    ...
    /* STA al */
        case (0x8F<<4)|0: /* (unimpl) */;_VDA(_GB());_SD(_A(c));_WR();break;
        case (0x8F<<4)|1: if(_a8(c)){_FETCH();}else{_VDA(_GB());_SALD(_GAL()+1,_B(c));_WR();}break;
        case (0x8F<<4)|2: _FETCH();break;
    ...
    /* BCC r */
        ...
        case (0x90<<4)|2: _SA((c->PC&0xFF00)|(c->AD&0x00FF));if((c->AD&0xFF00)==(c->PC&0xFF00)){c->PC=c->AD;c->irq_pip>>=1;c->nmi_pip>>=1;_FETCH();};break;
    ...
    /* STA (d),y */
        ...
        case (0x91<<4)|1: _VDA(c->DBR);c->AD=_GD();_SA(c->AD);break;
        case (0x91<<4)|2: _VDA(c->DBR);_SA((c->AD+1)&0xFF);c->AD=_GD();break;
        case (0x91<<4)|3: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_Y(c))&0xFF));break;
        case (0x91<<4)|4: _VDA(c->DBR);_SA(c->AD+_Y(c));_VDA(_GB());_SD(_A(c));_WR();break;
    ...
    /* STA (d) */
        case (0x92<<4)|0: /* (unimpl) */;_VDA(_GB());_SD(_A(c));_WR();break;
        case (0x92<<4)|1: if(_a8(c)){_FETCH();}else{_VDA(_GB());_SALD(_GAL()+1,_B(c));_WR();}break;
    ...
    /* STA (d,s),y */
        case (0x93<<4)|0: /* (unimpl) */;_VDA(_GB());_SD(_A(c));_WR();break;
        case (0x93<<4)|1: if(_a8(c)){_FETCH();}else{_VDA(_GB());_SALD(_GAL()+1,_B(c));_WR();}break;
        case (0x93<<4)|2: _FETCH();break;
    ...
    /* STY d,x */
        ...
        case (0x94<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0x94<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}_VDA(_GB());_SD(_Y(c));_WR();break;
        case (0x94<<4)|3: if(_i8(c)){_FETCH();}else{_VDA(_GB());_SALD(_GAL()+1,_YH(c));_WR();}break;
    ...
    /* STA d,x */
        ...
        case (0x95<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0x95<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}_VDA(_GB());_SD(_A(c));_WR();break;
        case (0x95<<4)|3: if(_a8(c)){_FETCH();}else{_VDA(_GB());_SALD(_GAL()+1,_B(c));_WR();}break;
        case (0x95<<4)|4: _FETCH();break;
    ...
    /* STX d,y */
        ...
        case (0x96<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0x96<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_Y(c))&0x00FF);}else{_SA(c->AD+_Y(c));}_VDA(_GB());_SD(_X(c));_WR();break;
        case (0x96<<4)|3: if(_i8(c)){_FETCH();}else{_VDA(_GB());_SALD(_GAL()+1,_XH(c));_WR();}break;
        case (0x96<<4)|4: _FETCH();break;
    ...
    /* STA [d],y */
        case (0x97<<4)|0: /* (unimpl) */;_VDA(_GB());_SD(_A(c));_WR();break;
        case (0x97<<4)|1: if(_a8(c)){_FETCH();}else{_VDA(_GB());_SALD(_GAL()+1,_B(c));_WR();}break;
        case (0x97<<4)|2: _FETCH();break;
        case (0x97<<4)|3: assert(false);break;
    ...
    /* TYA i */
        ...
        case (0x98<<4)|1: if(_a8(c)){_A(c)=_Y(c);_NZ(_A(c));}else{_C(c)=_Y16(c);_NZ16(_C(c));}_FETCH();break;
    ...
    /* STA a,y */
        ...
        case (0x99<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_Y(c))&0xFF));break;
        case (0x99<<4)|3: _VDA(c->DBR);_SA(c->AD+_Y(c));_VDA(_GB());_SD(_A(c));_WR();break;
    ...
    /* TXS i */
        ...
        case (0x9A<<4)|1: _S(c)=_X16(c);_FETCH();break;
    ...
    /* TXY i */
        ...
        case (0x9B<<4)|1: if(_i8(c)){_Y(c)=_X(c);_NZ(_Y(c));}else{_Y16(c)=_X16(c);_NZ16(_Y16(c));}_FETCH();break;
    ...
    /* STZ a */
        ...
        case (0x9C<<4)|2: _VDA(c->DBR);_SA((_GD()<<8)|c->AD);_VDA(_GB());_SD(0);_WR();break;
    ...
    /* STA a,x */
        ...
        case (0x9D<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_X(c))&0xFF));break;
        case (0x9D<<4)|3: _VDA(c->DBR);_SA(c->AD+_X(c));_VDA(_GB());_SD(_A(c));_WR();break;
    ...
    /* STZ a,x */
        ...
        case (0x9E<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_X(c))&0xFF));break;
        case (0x9E<<4)|3: _VDA(c->DBR);_SA(c->AD+_X(c));_VDA(_GB());_SD(0);_WR();break;
    ...
    /* STA al,x */
        case (0x9F<<4)|0: /* (unimpl) */;_VDA(_GB());_SD(_A(c));_WR();break;
        case (0x9F<<4)|1: if(_a8(c)){_FETCH();}else{_VDA(_GB());_SALD(_GAL()+1,_B(c));_WR();}break;
    ...
    /* LDY # */
        ...
        case (0xA0<<4)|1: _Y(c)=_GD();if(_i8(c)){_NZ(_Y(c));_FETCH();}else{_VPA();_SA(c->PC++);}break;
    ...
    /* LDA (d,x) */
        ...
        case (0xA1<<4)|2: _VDA(c->DBR);c->AD=(c->AD+_X(c))&0xFF;_SA(c->AD);break;
        case (0xA1<<4)|3: _VDA(c->DBR);_SA((c->AD+1)&0xFF);c->AD=_GD();break;
        case (0xA1<<4)|4: _VDA(c->DBR);_SA((_GD()<<8)|c->AD);break;
        case (0xA1<<4)|5: _A(c)=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xA1<<4)|6: _B(c)=_GD();_NZ16(_C(c));_FETCH();break;
        case (0xA1<<4)|7: assert(false);break;
        case (0xA1<<4)|8: assert(false);break;
    /* LDX # */
        case (0xA2<<4)|0: _VPA();_SA(c->PC++);break;
        case (0xA2<<4)|1: _X(c)=_GD();if(_i8(c)){_NZ(_X(c));_FETCH();}else{_VPA();_SA(c->PC++);}break;
    ...
    /* LDA d,s */
        ...
        case (0xA3<<4)|1: _A(c)=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xA3<<4)|2: _B(c)=_GD();_NZ16(_C(c));_FETCH();break;
    ...
    /* LDY d */
        case (0xA4<<4)|0: _VPA();_SA(c->PC++);break;
        case (0xA4<<4)|1: _VDA(0);_SA(_GD());break;
        case (0xA4<<4)|2: _Y(c)=_GD();if(_i8(c)){_NZ(_Y(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xA4<<4)|3: _YH(c)=_GD();_NZ16(_Y(c));_FETCH();break;
        case (0xA4<<4)|4: assert(false);break;
    ...
    /* LDA d */
        case (0xA5<<4)|0: _VPA();_SA(c->PC++);break;
        case (0xA5<<4)|1: _VDA(0);_SA(_GD());break;
        case (0xA5<<4)|2: _A(c)=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xA5<<4)|3: _B(c)=_GD();_NZ16(_C(c));_FETCH();break;
        case (0xA5<<4)|4: assert(false);break;
    ...
    /* LDX d */
        case (0xA6<<4)|0: _VPA();_SA(c->PC++);break;
        case (0xA6<<4)|1: _VDA(0);_SA(_GD());break;
        case (0xA6<<4)|2: _X(c)=_GD();if(_i8(c)){_NZ(_X(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xA6<<4)|3: _XH(c)=_GD();_NZ16(_X(c));_FETCH();break;
        case (0xA6<<4)|4: assert(false);break;
    ...
    /* LDA [d] */
        ...
        case (0xA7<<4)|1: _A(c)=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xA7<<4)|2: _B(c)=_GD();_NZ16(_C(c));_FETCH();break;
        case (0xA7<<4)|3: assert(false);break;
    ...
    /* TAY i */
        ...
        case (0xA8<<4)|1: if(_i8(c)){_Y(c)=_A(c);_NZ(_Y(c));}else{_Y16(c)=_C(c);_NZ16(_Y16(c));}_FETCH();break;
    ...
    /* TAX i */
        ...
        case (0xAA<<4)|1: if(_i8(c)){_X(c)=_A(c);_NZ(_X(c));}else{_X16(c)=_C(c);_NZ16(_X16(c));}_FETCH();break;
    ...
    /* PLB s */
        ...
        case (0xAB<<4)|2: _VDA(0);_SA(0x0100|++_S(c));break;
    ...
    /* LDY a */
        ...
        case (0xAC<<4)|3: _Y(c)=_GD();if(_i8(c)){_NZ(_Y(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
    ...
    /* LDX a */
        ...
        case (0xAE<<4)|3: _X(c)=_GD();if(_i8(c)){_NZ(_X(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
    ...
    /* LDA al */
        case (0xAF<<4)|0: /* (unimpl) */;break;
        case (0xAF<<4)|1: _A(c)=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xAF<<4)|2: _B(c)=_GD();_NZ16(_C(c));_FETCH();break;
        case (0xAF<<4)|3: assert(false);break;
        case (0xAF<<4)|4: assert(false);break;
        case (0xAF<<4)|5: assert(false);break;
    ...
    /* BCS r */
        ...
        case (0xB0<<4)|2: _SA((c->PC&0xFF00)|(c->AD&0x00FF));if((c->AD&0xFF00)==(c->PC&0xFF00)){c->PC=c->AD;c->irq_pip>>=1;c->nmi_pip>>=1;_FETCH();};break;
    ...
    /* LDA (d),y */
        ...
        case (0xB1<<4)|1: _VDA(c->DBR);c->AD=_GD();_SA(c->AD);break;
        case (0xB1<<4)|2: _VDA(c->DBR);_SA((c->AD+1)&0xFF);c->AD=_GD();break;
        case (0xB1<<4)|3: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_Y(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_Y(c))>>8)))&1;break;
    ...
    /* LDA (d) */
        ...
        case (0xB2<<4)|1: _A(c)=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xB2<<4)|2: _B(c)=_GD();_NZ16(_C(c));_FETCH();break;
        case (0xB2<<4)|3: assert(false);break;
    ...
    /* LDA (d,s),y */
        ...
        case (0xB3<<4)|1: _A(c)=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xB3<<4)|2: _B(c)=_GD();_NZ16(_C(c));_FETCH();break;
    ...
    /* LDY d,x */
        ...
        case (0xB4<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0xB4<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}break;
        case (0xB4<<4)|3: _Y(c)=_GD();if(_i8(c)){_NZ(_Y(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xB4<<4)|4: _YH(c)=_GD();_NZ16(_Y(c));_FETCH();break;
    ...
    /* LDA d,x */
        ...
        case (0xB5<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0xB5<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}break;
        case (0xB5<<4)|3: _A(c)=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xB5<<4)|4: _B(c)=_GD();_NZ16(_C(c));_FETCH();break;
    ...
    /* LDX d,y */
        ...
        case (0xB6<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0xB6<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_Y(c))&0x00FF);}else{_SA(c->AD+_Y(c));}break;
        case (0xB6<<4)|3: _X(c)=_GD();if(_i8(c)){_NZ(_X(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xB6<<4)|4: _XH(c)=_GD();_NZ16(_X(c));_FETCH();break;
    ...
    /* LDA [d],y */
        ...
        case (0xB7<<4)|1: _A(c)=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xB7<<4)|2: _B(c)=_GD();_NZ16(_C(c));_FETCH();break;
        case (0xB7<<4)|3: assert(false);break;
    ...
    /* LDA a,y */
        ...
        case (0xB9<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_Y(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_Y(c))>>8)))&1;break;
    ...
    /* TSX i */
        ...
        case (0xBA<<4)|1: if(_i8(c)){_X(c)=_S(c);_NZ(_X(c));}else{_X16(c)=_S(c);_NZ16(_X16(c));}_FETCH();break;
    ...
    /* TYX i */
        ...
        case (0xBB<<4)|1: if(_i8(c)){_X(c)=_Y(c);_NZ(_X(c));}else{_X16(c)=_Y16(c);_NZ16(_X16(c));}_FETCH();break;
    ...
    /* LDY a,x */
        ...
        case (0xBC<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_X(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_X(c))>>8)))&1;break;
        case (0xBC<<4)|3: _VDA(c->DBR);_SA(c->AD+_X(c));break;
        case (0xBC<<4)|4: _Y(c)=_GD();if(_i8(c)){_NZ(_Y(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
    ...
    /* LDA a,x */
        ...
        case (0xBD<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_X(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_X(c))>>8)))&1;break;
    ...
    /* LDX a,y */
        ...
        case (0xBE<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_Y(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_Y(c))>>8)))&1;break;
        case (0xBE<<4)|3: _VDA(c->DBR);_SA(c->AD+_Y(c));break;
        case (0xBE<<4)|4: _X(c)=_GD();if(_i8(c)){_NZ(_X(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
    ...
    /* LDA al,x */
        case (0xBF<<4)|0: /* (unimpl) */;break;
        case (0xBF<<4)|1: _A(c)=_GD();if(_a8(c)){_NZ(_A(c));_FETCH();}else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xBF<<4)|2: _B(c)=_GD();_NZ16(_C(c));_FETCH();break;
        case (0xBF<<4)|3: assert(false);break;
    ...
    /* CPY # */
        ...
        case (0xC0<<4)|1: if(_a8(c)){_w65816_cmp(c, _Y(c), _GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xC0<<4)|2: _w65816_cmp16(c, _Y16(c), c->AD|(_GD()<<8));_FETCH();break;
    ...
    /* CMP (d,x) */
        ...
        case (0xC1<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0xC1<<4)|2: _VDA(c->DBR);c->AD=(c->AD+_X(c))&0xFF;_SA(c->AD);break;
        case (0xC1<<4)|3: _VDA(c->DBR);_SA((c->AD+1)&0xFF);c->AD=_GD();break;
        case (0xC1<<4)|4: _VDA(c->DBR);_SA((_GD()<<8)|c->AD);break;
        case (0xC1<<4)|5: if(_a8(c)){_w65816_cmp(c, _A(c), _GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xC1<<4)|6: _w65816_cmp16(c, _C(c), c->AD|(_GD()<<8));_FETCH();break;
    ...
    /* CMP d,s */
        ...
        case (0xC3<<4)|1: if(_a8(c)){_w65816_cmp(c, _A(c), _GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xC3<<4)|2: _w65816_cmp16(c, _C(c), c->AD|(_GD()<<8));break;
        case (0xC3<<4)|3: _FETCH();break;
    ...
    /* CPY d */
        case (0xC4<<4)|0: _VPA();_SA(c->PC++);break;
        case (0xC4<<4)|1: _VDA(0);_SA(_GD());break;
        case (0xC4<<4)|2: if(_a8(c)){_w65816_cmp(c, _Y(c), _GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xC4<<4)|3: _w65816_cmp16(c, _Y16(c), c->AD|(_GD()<<8));_FETCH();break;
    ...
    /* CMP d */
        case (0xC5<<4)|0: _VPA();_SA(c->PC++);break;
        case (0xC5<<4)|1: _VDA(0);_SA(_GD());break;
        case (0xC5<<4)|2: if(_a8(c)){_w65816_cmp(c, _A(c), _GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xC5<<4)|3: _w65816_cmp16(c, _C(c), c->AD|(_GD()<<8));_FETCH();break;
    ...
    /* DEC d */
        case (0xC6<<4)|0: _VPA();_SA(c->PC++);break;
        case (0xC6<<4)|1: _VDA(0);_SA(_GD());break;
        case (0xC6<<4)|2: c->AD=_GD();                 if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xC6<<4)|3: if(_a8(c)){_VDA(_GB());c->AD--;_NZ(c->AD);_SD(c->AD);_WR();}else{c->AD|=_GD()<<8;}break;
        case (0xC6<<4)|4: if(_a8(c)){_FETCH();                                       }else{_VDA(_GB());c->AD--;_NZ16(c->AD);_SD(c->AD>>8);_WR();}break;
        case (0xC6<<4)|5: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0xC6<<4)|6: _FETCH();break;
        case (0xC6<<4)|7: assert(false);break;
        case (0xC6<<4)|8: assert(false);break;
    /* CMP [d] */
        case (0xC7<<4)|0: /* (unimpl) */;break;
        case (0xC7<<4)|1: if(_a8(c)){_w65816_cmp(c, _A(c), _GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xC7<<4)|2: _w65816_cmp16(c, _C(c), c->AD|(_GD()<<8));break;
        case (0xC7<<4)|3: _FETCH();break;
    ...
    /* INY i */
        ...
        case (0xC8<<4)|1: if(_i8(c)){_Y(c)++;_NZ(_Y(c));}else{_Y16(c)++;_NZ16(_Y16(c));}_FETCH();break;
    ...
    /* CMP # */
        ...
        case (0xC9<<4)|1: if(_a8(c)){_w65816_cmp(c, _A(c), _GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
    ...
    /* DEX i */
        ...
        case (0xCA<<4)|1: if(_i8(c)){_X(c)--;_NZ(_X(c));}else{_X16(c)--;_NZ16(_X16(c));}_FETCH();break;
    ...
    /* CPY a */
        ...
        case (0xCC<<4)|3: if(_a8(c)){_w65816_cmp(c, _Y(c), _GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xCC<<4)|4: _w65816_cmp16(c, _Y16(c), c->AD|(_GD()<<8));_FETCH();break;
    ...
    /* DEC a */
        ...
        case (0xCE<<4)|3: c->AD=_GD();                 if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xCE<<4)|4: if(_a8(c)){_VDA(_GB());c->AD--;_NZ(c->AD);_SD(c->AD);_WR();}else{c->AD|=_GD()<<8;}break;
        case (0xCE<<4)|5: if(_a8(c)){_FETCH();                                       }else{_VDA(_GB());c->AD--;_NZ16(c->AD);_SD(c->AD>>8);_WR();}break;
        case (0xCE<<4)|6: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0xCE<<4)|7: _FETCH();break;
        case (0xCE<<4)|8: assert(false);break;
    /* CMP al */
        case (0xCF<<4)|0: /* (unimpl) */;break;
        case (0xCF<<4)|1: if(_a8(c)){_w65816_cmp(c, _A(c), _GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xCF<<4)|2: _w65816_cmp16(c, _C(c), c->AD|(_GD()<<8));break;
        case (0xCF<<4)|3: _FETCH();break;
    ...
    /* BNE r */
        ...
        case (0xD0<<4)|2: _SA((c->PC&0xFF00)|(c->AD&0x00FF));if((c->AD&0xFF00)==(c->PC&0xFF00)){c->PC=c->AD;c->irq_pip>>=1;c->nmi_pip>>=1;_FETCH();};break;
    ...
    /* CMP (d),y */
        ...
        case (0xD1<<4)|1: _VDA(c->DBR);c->AD=_GD();_SA(c->AD);break;
        case (0xD1<<4)|2: _VDA(c->DBR);_SA((c->AD+1)&0xFF);c->AD=_GD();break;
        case (0xD1<<4)|3: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_Y(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_Y(c))>>8)))&1;break;
    ...
    /* CMP (d) */
        ...
        case (0xD2<<4)|1: if(_a8(c)){_w65816_cmp(c, _A(c), _GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xD2<<4)|2: _w65816_cmp16(c, _C(c), c->AD|(_GD()<<8));break;
        case (0xD2<<4)|3: _FETCH();break;
    ...
    /* CMP (d,s),y */
        ...
        case (0xD3<<4)|1: if(_a8(c)){_w65816_cmp(c, _A(c), _GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xD3<<4)|2: _w65816_cmp16(c, _C(c), c->AD|(_GD()<<8));break;
        case (0xD3<<4)|3: _FETCH();break;
    ...
    /* CMP d,x */
        ...
        case (0xD5<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0xD5<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}break;
        case (0xD5<<4)|3: if(_a8(c)){_w65816_cmp(c, _A(c), _GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xD5<<4)|4: _w65816_cmp16(c, _C(c), c->AD|(_GD()<<8));_FETCH();break;
    ...
    /* DEC d,x */
        ...
        case (0xD6<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0xD6<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}break;
        case (0xD6<<4)|3: c->AD=_GD();                 if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xD6<<4)|4: if(_a8(c)){_VDA(_GB());c->AD--;_NZ(c->AD);_SD(c->AD);_WR();}else{c->AD|=_GD()<<8;}break;
        case (0xD6<<4)|5: if(_a8(c)){_FETCH();                                       }else{_VDA(_GB());c->AD--;_NZ16(c->AD);_SD(c->AD>>8);_WR();}break;
        case (0xD6<<4)|6: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0xD6<<4)|7: _FETCH();break;
        case (0xD6<<4)|8: assert(false);break;
    /* CMP [d],y */
        case (0xD7<<4)|0: /* (unimpl) */;break;
        case (0xD7<<4)|1: if(_a8(c)){_w65816_cmp(c, _A(c), _GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xD7<<4)|2: _w65816_cmp16(c, _C(c), c->AD|(_GD()<<8));break;
    ...
    /* CMP a,y */
        ...
        case (0xD9<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_Y(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_Y(c))>>8)))&1;break;
    ...
    /* PHX s */
        ...
        case (0xDA<<4)|1: _VDA(0);_SAD(0x0100|_S(c)--,_X(c));_WR();break;
    ...
    /* JML (a) (unimpl) */
        case (0xDC<<4)|0: _FETCH();break;
        case (0xDC<<4)|1: assert(false);break;
    ...
    /* CMP a,x */
        ...
        case (0xDD<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_X(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_X(c))>>8)))&1;break;
    ...
    /* DEC a,x */
        ...
        case (0xDE<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_X(c))&0xFF));break;
        case (0xDE<<4)|3: _VDA(c->DBR);_SA(c->AD+_X(c));break;
        case (0xDE<<4)|4: c->AD=_GD();                 if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xDE<<4)|5: if(_a8(c)){_VDA(_GB());c->AD--;_NZ(c->AD);_SD(c->AD);_WR();}else{c->AD|=_GD()<<8;}break;
        case (0xDE<<4)|6: if(_a8(c)){_FETCH();                                       }else{_VDA(_GB());c->AD--;_NZ16(c->AD);_SD(c->AD>>8);_WR();}break;
        case (0xDE<<4)|7: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0xDE<<4)|8: _FETCH();break;
    /* CMP al,x */
        case (0xDF<<4)|0: /* (unimpl) */;break;
        case (0xDF<<4)|1: if(_a8(c)){_w65816_cmp(c, _A(c), _GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xDF<<4)|2: _w65816_cmp16(c, _C(c), c->AD|(_GD()<<8));break;
        case (0xDF<<4)|3: _FETCH();break;
    ...
    /* CPX # */
        ...
        case (0xE0<<4)|1: if(_a8(c)){_w65816_cmp(c, _X(c), _GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xE0<<4)|2: _w65816_cmp16(c, _X16(c), c->AD|(_GD()<<8));_FETCH();break;
    ...
    /* SBC (d,x) */
        ...
        case (0xE1<<4)|2: _VDA(c->DBR);c->AD=(c->AD+_X(c))&0xFF;_SA(c->AD);break;
        case (0xE1<<4)|3: _VDA(c->DBR);_SA((c->AD+1)&0xFF);c->AD=_GD();break;
        case (0xE1<<4)|4: _VDA(c->DBR);_SA((_GD()<<8)|c->AD);break;
        case (0xE1<<4)|5: if(_a8(c)){_w65816_sbc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xE1<<4)|6: _w65816_sbc16(c,c->AD|(_GD()<<8));_FETCH();break;
    ...
    /* SBC d,s */
        ...
        case (0xE3<<4)|1: if(_a8(c)){_w65816_sbc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xE3<<4)|2: _w65816_sbc16(c,c->AD|(_GD()<<8));break;
        case (0xE3<<4)|3: _FETCH();break;
    ...
    /* CPX d */
        case (0xE4<<4)|0: _VPA();_SA(c->PC++);break;
        case (0xE4<<4)|1: _VDA(0);_SA(_GD());break;
        case (0xE4<<4)|2: if(_a8(c)){_w65816_cmp(c, _X(c), _GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xE4<<4)|3: _w65816_cmp16(c, _X16(c), c->AD|(_GD()<<8));_FETCH();break;
        case (0xE4<<4)|4: assert(false);break;
    ...
    /* SBC d */
        case (0xE5<<4)|0: _VPA();_SA(c->PC++);break;
        case (0xE5<<4)|1: _VDA(0);_SA(_GD());break;
        case (0xE5<<4)|2: if(_a8(c)){_w65816_sbc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xE5<<4)|3: _w65816_sbc16(c,c->AD|(_GD()<<8));_FETCH();break;
        case (0xE5<<4)|4: assert(false);break;
    ...
    /* INC d */
        case (0xE6<<4)|0: _VPA();_SA(c->PC++);break;
        case (0xE6<<4)|1: _VDA(0);_SA(_GD());break;
        case (0xE6<<4)|2: c->AD=_GD();                 if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xE6<<4)|3: if(_a8(c)){_VDA(_GB());c->AD++;_NZ(c->AD);_SD(c->AD);_WR();}else{c->AD|=_GD()<<8;}break;
        case (0xE6<<4)|4: if(_a8(c)){_FETCH();                                       }else{_VDA(_GB());c->AD++;_NZ16(c->AD);_SD(c->AD>>8);_WR();}break;
        case (0xE6<<4)|5: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0xE6<<4)|6: _FETCH();break;
        case (0xE6<<4)|7: assert(false);break;
        case (0xE6<<4)|8: assert(false);break;
    /* SBC [d] */
        case (0xE7<<4)|0: /* (unimpl) */;break;
        case (0xE7<<4)|1: if(_a8(c)){_w65816_sbc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xE7<<4)|2: _w65816_sbc16(c,c->AD|(_GD()<<8));break;
        case (0xE7<<4)|3: _FETCH();break;
        case (0xE7<<4)|4: assert(false);break;
    ...
    /* INX i */
        ...
        case (0xE8<<4)|1: if(_i8(c)){_X(c)++;_NZ(_X(c));}else{_X16(c)++;_NZ16(_X16(c));}_FETCH();break;
    ...
    /* SBC # */
        ...
        case (0xE9<<4)|1: if(_a8(c)){_w65816_sbc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
    ...
    /* CPX a */
        ...
        case (0xEC<<4)|3: if(_a8(c)){_w65816_cmp(c, _X(c), _GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xEC<<4)|4: _w65816_cmp16(c, _X16(c), c->AD|(_GD()<<8));_FETCH();break;
    ...
    /* INC a */
        ...
        case (0xEE<<4)|3: c->AD=_GD();                 if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xEE<<4)|4: if(_a8(c)){_VDA(_GB());c->AD++;_NZ(c->AD);_SD(c->AD);_WR();}else{c->AD|=_GD()<<8;}break;
        case (0xEE<<4)|5: if(_a8(c)){_FETCH();                                       }else{_VDA(_GB());c->AD++;_NZ16(c->AD);_SD(c->AD>>8);_WR();}break;
        case (0xEE<<4)|6: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0xEE<<4)|7: _FETCH();break;
        case (0xEE<<4)|8: assert(false);break;
    /* SBC al */
        case (0xEF<<4)|0: /* (unimpl) */;break;
        case (0xEF<<4)|1: if(_a8(c)){_w65816_sbc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xEF<<4)|2: _w65816_sbc16(c,c->AD|(_GD()<<8));break;
        case (0xEF<<4)|3: _FETCH();break;
        case (0xEF<<4)|4: assert(false);break;
        case (0xEF<<4)|5: assert(false);break;
    ...
    /* BEQ r */
        ...
        case (0xF0<<4)|2: _SA((c->PC&0xFF00)|(c->AD&0x00FF));if((c->AD&0xFF00)==(c->PC&0xFF00)){c->PC=c->AD;c->irq_pip>>=1;c->nmi_pip>>=1;_FETCH();};break;
    ...
    /* SBC (d),y */
        ...
        case (0xF1<<4)|1: _VDA(c->DBR);c->AD=_GD();_SA(c->AD);break;
        case (0xF1<<4)|2: _VDA(c->DBR);_SA((c->AD+1)&0xFF);c->AD=_GD();break;
        case (0xF1<<4)|3: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_Y(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_Y(c))>>8)))&1;break;
    ...
    /* SBC (d) */
        ...
        case (0xF2<<4)|1: if(_a8(c)){_w65816_sbc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xF2<<4)|2: _w65816_sbc16(c,c->AD|(_GD()<<8));break;
    ...
    /* SBC (d,s),y */
        ...
        case (0xF3<<4)|1: if(_a8(c)){_w65816_sbc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xF3<<4)|2: _w65816_sbc16(c,c->AD|(_GD()<<8));break;
        case (0xF3<<4)|3: _FETCH();break;
    ...
    /* SBC d,x */
        ...
        case (0xF5<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0xF5<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}break;
        case (0xF5<<4)|3: if(_a8(c)){_w65816_sbc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xF5<<4)|4: _w65816_sbc16(c,c->AD|(_GD()<<8));_FETCH();break;
    ...
    /* INC d,x */
        ...
        case (0xF6<<4)|1: c->AD=_GD();_SA(c->AD);break;
        case (0xF6<<4)|2: _VDA(0);if(_E(c)){_SA((c->AD+_X(c))&0x00FF);}else{_SA(c->AD+_X(c));}break;
        case (0xF6<<4)|3: c->AD=_GD();                 if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xF6<<4)|4: if(_a8(c)){_VDA(_GB());c->AD++;_NZ(c->AD);_SD(c->AD);_WR();}else{c->AD|=_GD()<<8;}break;
        case (0xF6<<4)|5: if(_a8(c)){_FETCH();                                       }else{_VDA(_GB());c->AD++;_NZ16(c->AD);_SD(c->AD>>8);_WR();}break;
        case (0xF6<<4)|6: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0xF6<<4)|7: _FETCH();break;
        case (0xF6<<4)|8: assert(false);break;
    /* SBC [d],y */
        case (0xF7<<4)|0: /* (unimpl) */;break;
        case (0xF7<<4)|1: if(_a8(c)){_w65816_sbc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xF7<<4)|2: _w65816_sbc16(c,c->AD|(_GD()<<8));break;
        case (0xF7<<4)|3: _FETCH();break;
        case (0xF7<<4)|4: assert(false);break;
    ...
    /* SBC a,y */
        ...
        case (0xF9<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_Y(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_Y(c))>>8)))&1;break;
    ...
    /* PLX s */
        ...
        case (0xFA<<4)|2: _VDA(0);_SA(0x0100|++_S(c));break;
        case (0xFA<<4)|3: _X(c)=_GD();_NZ(_X(c));_FETCH();break;
    ...
    /* JSR (a,x) */
        ...
        case (0xFC<<4)|1: _VDA(0);_SAD(0x0100|_S(c)--,c->PC>>8);_WR();break;
        case (0xFC<<4)|2: _VDA(0);_SAD(0x0100|_S(c)--,c->PC);_WR();break;
        case (0xFC<<4)|3: _VPA();_SA(c->PC);break;
        case (0xFC<<4)|4: _SA(c->PC);c->AD=(_GD()<<8)|c->AD;break;
        case (0xFC<<4)|5: _VDA(_GB());_SA(c->AD+_X(c));break;
        case (0xFC<<4)|6: _VDA(_GB());_SA(c->AD+_X(c)+1);c->AD=_GD();break;
    ...
    /* SBC a,x */
        ...
        case (0xFD<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_X(c))&0xFF));c->IR+=(~((c->AD>>8)-((c->AD+_X(c))>>8)))&1;break;
    ...
    /* INC a,x */
        ...
        case (0xFE<<4)|2: c->AD|=_GD()<<8;_SA((c->AD&0xFF00)|((c->AD+_X(c))&0xFF));break;
        case (0xFE<<4)|3: _VDA(c->DBR);_SA(c->AD+_X(c));break;
        case (0xFE<<4)|4: c->AD=_GD();                 if(_a8(c)){ if(_E(c)){_WR();} }else{_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xFE<<4)|5: if(_a8(c)){_VDA(_GB());c->AD++;_NZ(c->AD);_SD(c->AD);_WR();}else{c->AD|=_GD()<<8;}break;
        case (0xFE<<4)|6: if(_a8(c)){_FETCH();                                       }else{_VDA(_GB());c->AD++;_NZ16(c->AD);_SD(c->AD>>8);_WR();}break;
        case (0xFE<<4)|7: _VDA(_GB());_SALD(_GAL()-1,c->AD);_WR();break;
        case (0xFE<<4)|8: _FETCH();break;
    /* SBC al,x */
        case (0xFF<<4)|0: /* (unimpl) */;break;
        case (0xFF<<4)|1: if(_a8(c)){_w65816_sbc(c,_GD());_FETCH();}else{c->AD=_GD();_VDA(_GB());_SAL(_GAL()+1);}break;
        case (0xFF<<4)|2: _w65816_sbc16(c,c->AD|(_GD()<<8));break;
